  ...
  return (
    <div className="container-zenicorp py-12 max-w-2xl">
      <div className="text-center mb-10">
        ...
        <p className="body-base mt-3">10 étapes à 2 minutes — Réponse sous 24h</p>
      </div>
      ...
      <form className="card p-8">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {['Toiture résidentielle', 'Toiture commerciale', 'Réparation de fuites'].map((o) => (
        ...
        <div className="mb-8">
          <h2 className="heading-3 mb-4 flex items-center gap-2">
            <span className="text-zenicorp-gold font-bold">4.</span> Dimensions de la toiture
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="mb-8">
          ...
          <textarea className="input-field min-h-32" placeholder="Décrivez votre projet : type de revêtement actuel, âge de la toiture, fuites constatées, pente..." />
        </div>

        {/* ÉTAPE 6 */}
        <div className="mb-8">
          <h2 className="heading-3 mb-4 flex items-center gap-2">
            <span className="text-zenicorp-gold font-bold">6.</span> Photos de la toiture
          </h2>
        ...
        <div className="mb-8 bg-zenicorp-lightGray border border-zenicorp-border p-6">
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            {[
              ['Type de projet', 'Toiture résidentielle'],
        ...
        <p className="text-center text-xs text-zenicorp-mediumGray mt-4 flex items-center justify-center gap-1">
          <CheckCircle2 className="w-4 h-4 text-zenicorp-gold" /> Réponse garantie sous 24h ouvrables. Aucun engagement.
        </p>
      </form>
    </div>
  );
